...
/**
 * This is a simple example for an aggregator writer. After each superstep the writer will persist the aggregator values to disk, by use of the Writable interface. The file will be created on the
 * current working directory.
 */
public class TriangleCountAggregatorWriter extends
	...
	for (Entry<String, Writable> entry : aggregatorMap) {
		output.writeChars("Totale triangoli\t" + entry.getValue() + "\n");
	}
	output.flush();
    }
