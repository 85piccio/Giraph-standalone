 ...
 * @author piccio
 */
public class VertexCompute extends BasicComputation<LongWritable, VertexValue, NullWritable, LongWritable> {

    /**
     * Class logger
     */
    private static final Logger LOG = Logger.getLogger(VertexCompute.class);
    /**
