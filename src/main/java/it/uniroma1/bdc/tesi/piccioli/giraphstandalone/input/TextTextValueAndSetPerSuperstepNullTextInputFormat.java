 ...
 */
public class TextTextValueAndSetPerSuperstepNullTextInputFormat extends
    TextVertexInputFormat<Text, TextValueAndSetPerSuperstep, NullWritable> {
...
//  private static final Pattern SEPARATOR = Pattern.compile("[\t ]");
  ...
  public TextVertexInputFormat.TextVertexReader createVertexReader(InputSplit split,
    ...
    throws IOException {
    return new TextValueAndSetPerSuperstepNullReader();
  }

  /**
   * Vertex reader associated with {@link LongLongNullLongTextInputFormat}.
   */
  public class TextValueAndSetPerSuperstepNullReader extends
      TextVertexReaderFromEachLineProcessed<String[]> {
    /** Cached vertex id for the current line */
    private Text id;
    private TextValueAndSetPerSuperstep value;

    @Override
    protected String[] preprocessLine(Text line) throws IOException {
      String[] tokens = SEPARATOR.split(line.toString());
      id = new Text(tokens[0]);
//      value = new TextValueAndSetPerSuperstep(new Text(Double.toString(0.0)));
      value = new TextValueAndSetPerSuperstep();
      return tokens;
    }
    ...
    @Override
    protected TextValueAndSetPerSuperstep getValue(String[] tokens) throws IOException {
      return value;
    }
