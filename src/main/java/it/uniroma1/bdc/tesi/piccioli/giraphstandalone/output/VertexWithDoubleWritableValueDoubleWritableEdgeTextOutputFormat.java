 ...
 * null edges
 */
public class VertexWithDoubleWritableValueDoubleWritableEdgeTextOutputFormat extends
  ...
  public TextVertexOutputFormat.TextVertexWriter createVertexWriter(TaskAttemptContext context)
    ...
    return new VertexWithDoubleWritableValueWriter();
  }
   ...
   */
  public class VertexWithDoubleWritableValueWriter extends  TextVertexWriter {
    @Override
    public void writeVertex(
      ...
      output.append('\t');
      output.append(vertex.getValue().toString());
