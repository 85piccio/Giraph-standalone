 ...
 */
public class DenseSubgraphDirectPartitionS extends BasicComputation<IntWritable, DenseSubgraphDirectVertexValue, NullWritable, IntWritable> {
    ...
    @Override
    public void compute(Vertex<IntWritable, DenseSubgraphDirectVertexValue, NullWritable> vertex, Iterable<IntWritable> messages) throws IOException {
