 ...
 * null edges
 */
public class VertexWithTextAndHashesValueNullEdgeTextOutputFormat extends
    TextVertexOutputFormat<Text, TextAndHashes, NullWritable> {
  @Override
  ...
  public class VertexWithTextValueWriter extends  TextVertexWriter {
    ...
    public void writeVertex(
        Vertex<Text, TextAndHashes, NullWritable> vertex)
      throws IOException, InterruptedException {
