 ...
 */
public class TextTextAndHashesNullTextInputFormat extends
    TextVertexInputFormat<Text, TextAndHashes, NullWritable> {
...
//  private static final Pattern SEPARATOR = Pattern.compile("[\t ]");
  ...
  public class TextTextNullVertexReader extends
    ...
    private Text id;
    private TextAndHashes value;

    @Override
    protected String[] preprocessLine(Text line) throws IOException {
      String[] tokens = SEPARATOR.split(line.toString());
      id = new Text(tokens[0]);
      value = new TextAndHashes(new Text(Double.toString(0.0)));
      return tokens;
    }
    ...
    @Override
    protected TextAndHashes getValue(String[] tokens) throws IOException {
      return value;
    }
