...
In questa tesi verrà prima fornito un approfondimento sui modelli presi in analisi. Nel secondo capitolo verrà approfondito il modello MapReduce mentre nel terzo capitolo verrà descritto in dettaglio il modello introdotto con Pregel.

Nel capitolo successivo, il quarto, verranno descritti gli algoritmi selezionati per il confronto tra i due modelli. Per ogni algoritmo verrà fornito una descrizione generale, l'implementazione MapReduce e l'implementazione Pregel.

Infine verranno descritti gli esperimenti eseguiti ed i risultati ottenuti dall'esecuzioni delle implementazioni realizzate per i due modelli. Nel corso dell'ultimo capitolo saranno inoltre confrontate le prestazioni con lo scopo di fornire un analisi qualitativa sul comportamento dei due modelli applicati agli algoritmi su grafi.AAAA
